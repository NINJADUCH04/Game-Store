      ...
      <div className="min-h-screen bg-slate-950/80 flex flex-col">
        ...
        <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 flex-1 w-full">
          <div className="mb-6">
            <Link
              href="/products"
              className="inline-flex items-center text-xs font-orbitron text-purple-400 hover:text-purple-300 transition tracking-wider"
            >
              ← BACK TO CATALOG
            </Link>
          </div>
          ...
          {loading ? (
            ...
            <div className="bg-slate-900/90 border border-purple-500/30 rounded-2xl p-6 sm:p-10 shadow-2xl relative overflow-hidden backdrop-blur-md">
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-xs font-orbitron text-slate-400">
                    ...
                    <div className="bg-slate-950/40 p-3 rounded-lg border border-slate-800/80">
                      ...
                      <strong className="text-purple-400">AUTOMATIC CODE</strong>
                    </div>
                  </div>
                </div>

                <div className="w-full md:w-80 flex flex-col justify-between bg-slate-950/80 p-6 rounded-xl border border-purple-500/30 h-fit">
                  <div>
                    <span className="text-xs font-orbitron text-slate-400 block mb-1">PRICE</span>
                    <div className="text-3xl font-black font-orbitron text-yellow-400 mb-6">
                  ...
                  <div className="space-y-3">
                    <button
                      ...
                      disabled={purchasing}
                      className="w-full bg-indigo-600 hover:bg-indigo-500 text-white font-orbitron text-xs font-bold py-3.5 rounded-xl transition uppercase tracking-wider block shadow-lg shadow-purple-950/50 cursor-pointer disabled:opacity-50"
                    >
